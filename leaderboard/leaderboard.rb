...
# The ranked players will have ranks 1, 2, 2, and 3, respectively. If the player's scores are 70, 80 and 105, their rankings after each game are 4th, gra and 18t. Return [4, 3, 1].
# Function Description

# Complete the climbing Leaderboard function in the editor below.
